...
public interface TransactionService {
    ...
    Long getNextTransactionId() throws DataAccessException;
    void addTransaction(Transaction transaction) throws DataAccessException;
    Transaction getTransactionById(Long id) throws DataAccessException;
    ...
    double getAccountBalance(Long accountId) throws DataAccessException;
}